...
'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
  ...
  #top three PC (1 B, 2 A) - In2Lt
  PhenoLoadNames_In2Lt_8=ll_In2Lt[variable=="Dim.8"][quan>.9]
  PhenoLoadNames_In2Lt_8 <- PhenoLoadNames_In2Lt_8$pheno
  
  PhenoLoadNames_In2Lt_4=ll_In2Lt[variable=="Dim.4"][quan>.9]
  PhenoLoadNames_In2Lt_4 <- PhenoLoadNames_In2Lt_4$pheno
  
  PhenoLoadNames_In2Lt_9=ll_In2Lt[variable=="Dim.9"][quan>.9]
  PhenoLoadNames_In2Lt_9 <- PhenoLoadNames_In2Lt_9$pheno
  
  In2Lt_SemiSignificant_Pheno <- data.frame(PhenoLoadNames_In2Lt_8, PhenoLoadNames_In2Lt_4, PhenoLoadNames_In2Lt_9)
  In2Lt_SemiSignificant_Pheno_Graph <- barplot(prop.table(table(In2Lt_SemiSignificant_Pheno)))
