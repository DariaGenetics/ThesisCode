...
AllPhenoWOInversionStatus78 <- AllPhenoWOInversionStatus[, ..z]
AllPhenoPCA2 = imputePCA(AllPhenoWOInversionStatus78, scale.unit=TRUE, ncp=5, graph=T)
PrincipleComponents78 <- AllPhenoPCA2$fittedX
PrincipleComponents78DT <- as.data.frame(PrincipleComponents78)
PrincipleComponents78DT$RalId <- RalID
PrincipleComponents78DT$In2LtStatus <- In2LtStatus
write_xlsx(PrincipleComponents78DT,"/Users/dgg/Desktop/PrincipleComponents78.xlsx") 
